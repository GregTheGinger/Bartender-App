...
namespace Bartender_App.Controllers
{
    public class DrinksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DrinkID,DrinkName")] Drink drink)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DrinkID,DrinkName")] Drink drink)
        {
            if (id != drink.DrinkID)
            {
                return NotFound();
